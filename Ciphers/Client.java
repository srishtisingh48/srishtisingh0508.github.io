// This class represents the Client class and uses the Cipher class and its subclasses. 
// It does not actually implement any of it.
import java.util.*;
import java.io.*;
...
public class Client {
    ...
    public static final Cipher CHOSEN_CIPHER = new MultiCipher(List.of(
         new CaesarShift(4), new CaesarKey("BAG"),
         new CaesarShift(8)));
